...
__decorate([
    ...
    (0, swagger_1.ApiCreatedResponse)({ type: user_dto_1.UserResponseDto }),
...
__decorate([
    ...
    (0, permissions_decorator_1.Permissions)('MANAGE_USERS'),
    (0, swagger_1.ApiBody)({ type: user_dto_1.SetUserRolesDto }),
    (0, swagger_1.ApiOkResponse)({ type: user_dto_1.UserResponseDto }),
    (0, swagger_1.ApiOperation)({ summary: 'Replace user roles' }),
    __param(0, (0, common_1.Param)('id', common_1.ParseIntPipe)),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number, user_dto_1.SetUserRolesDto]),
    __metadata("design:returntype", void 0)
