...
__decorate([
    (0, typeorm_1.Column)({ name: 'enabled', type: 'tinyint', width: 1, default: true }),
...
__decorate([
    (0, typeorm_1.ManyToMany)(() => role_entity_1.RoleEntity, (role) => role.users, { cascade: false }),
...
__decorate([
    (0, typeorm_1.OneToOne)(() => employe_entity_1.EmployeEntity, (employe) => employe.user),
    __metadata("design:type", Object)
], UserEntity.prototype, "employe", void 0);
